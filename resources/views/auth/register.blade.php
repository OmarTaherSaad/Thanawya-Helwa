        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-md-4 col-form-label text-md-right">البريد الالكتروني (الايميل)</label>
                    ...
                    <div class="form-group row">
                        <label for="mobile_number" class="col-md-4 col-form-label text-md-right">رقم الموبايل</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="لابد أن تكون 8 حروف/رموز/أرقام على الأقل">
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-12">
                            ...
                            <a role="button" href="{{ route('ProviderAuth',['provider' => 'facebook']) }}" class="btn btn-light">
                                ...
                                <span> تسجيل باستخدام الفيسبوك</span>
                            </a>
                        </div>
                    </div>
                </form>
