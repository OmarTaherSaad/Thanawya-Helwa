    ...
    <div class="row justify-content-center text-center mt-5">
        <div class="col-12 col-md-6">
            ...
            <div class="form-group" v-if="type != null">
                ...
                <input type="text" class="form-control" v-model="question.text" id="" aria-describedby="helpId"
        ...
        <div class="col-6">
            ...
            <div class="form-group m-2">
                ...
                <select class="form-control" v-model="maker">
                    ...
                    <option value="{{ $key }}" @if($quiz->maker && $quiz->maker->id == $key) selected @endif>{{ $member }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group m-2">
                ...
                <select class="form-control" v-model="revisor">
                    ...
                    @foreach ($members as $key => $member)
                    <option value="{{ $key }}" @if($quiz->revisor && $quiz->revisor->id == $key) selected @endif>{{ $member }}</option>
                    @endforeach
                </select>
            </div>
