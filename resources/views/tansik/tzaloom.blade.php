            ...
            <div class="card">
                ...
                <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#TzalomQuestions">
                    <div class="card-body">
                        <p>
                            <ul class="list-group text-right">
                                <li class="list-group-item">أولًا: هتروح أقرب فرع للبنك الأهلي المصري أو البريد وهتدفع
                                    100 جنية عن كل مادة عايز تعملها تظلم .. هتدفع لحساب صندوق دعم وتمويل المشروعات
                                    التعليمية وهتاخد نسخة من
                                    إيصال السداد.</li>
                                <li class="list-group-item">ثانيًا: هتروح لمقر قبول الطلبات (في الصورة اللي تحت) الخاصة
                                    بمحافظتك أو تروح المديرية التعليمية، وتسلم
                                    الإيصال ده عشان يحددولك ميعاد
                                    للكشف عن ورقتك، ولما تيجي رايح المعاد ده متاخدش مدرس المادة لأن ممنوع.</li>
                                <li class="list-group-item">ثالثًا: لما تروح ميعادك هيدولك صورة من ورقة إجابتك لكن من
                                    ...
                                    حسابك من قبلها.</li>
                                <li class="list-group-item">رابعًا: هتسلم الورقة الخارجية وصورة ورقة إجابتك عشان
