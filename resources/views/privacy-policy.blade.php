...
@section('content')
    <div class="row" dir="ltr">
        <div class="col-12 col-md-10">
            ...
            <p>Your privacy is important to us. It is Thanawya Helwa's policy to respect your privacy regarding any information we
                may collect from you across our website, <a
                    href="https://www.thanawyahelwa.org/">www.thanawyahelwa.org</a>, and other sites we own and operate.
            </p>
    ...
    <div class="row" dir="ltr">
        <div class="col-12 col-md-10">
            ...
            <h3>1. Terms</h3>
            <p>By accessing the website at <a href="https://www.thanawyahelwa.org/">www.thanawyahelwa.org</a>, you are
                ...
                prohibited from using or accessing this site. The materials contained in this website are protected by applicable
                copyright and trademark law.</p>
            <h3>2. Use License</h3>
            <ol type="a">
                <li>Permission is granted to temporarily download one copy of the materials (information or software) on Thanawya
                    Helwa's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a
                    transfer of title, and under this license you may not:
                    <ol type="i">
                        <li>modify or copy the materials;</li>
                        <li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);
                        </li>
                        <li>attempt to decompile or reverse engineer any software contained on Thanawya Helwa's website;</li>
                ...
                <li>This license shall automatically terminate if you violate any of these restrictions and may be terminated by
                    Thanawya Helwa at any time. Upon terminating your viewing of these materials or upon the termination of this
                    license, you must destroy any downloaded materials in your possession whether in electronic or printed format.
                </li>
            </ol>
            <h3>3. Disclaimer</h3>
            <ol type="a">
                <li>The materials on Thanawya Helwa's website are provided on an 'as is' basis. Thanawya Helwa makes no warranties,
                ...
                <li>Further, Thanawya Helwa does not warrant or make any representations concerning the accuracy, likely results, or
            ...
            <h3>4. Limitations</h3>
            <p>In no event shall Thanawya Helwa or its suppliers be liable for any damages (including, without limitation, damages
                for loss of data or profit, or due to business interruption) arising out of the use or inability to use the
                materials on Thanawya Helwa's website, even if Thanawya Helwa or a Thanawya Helwa authorized representative has been
            ...
            <p>The materials appearing on Thanawya Helwa's website could include technical, typographical, or photographic errors.
                Thanawya Helwa does not warrant that any of the materials on its website are accurate, complete or current. Thanawya
                Helwa may make changes to the materials contained on its website at any time without notice. However Thanawya Helwa
                does not make any commitment to update the materials.</p>
            <h3>6. Links</h3>
            <p>Thanawya Helwa has not reviewed all of the sites linked to its website and is not responsible for the contents of any
                such linked site. The inclusion of any link does not imply endorsement by Thanawya Helwa of the site. Use of any
                such linked website is at the user's own risk.</p>
            <h3>7. Modifications</h3>
            <p>Thanawya Helwa may revise these terms of service for its website at any time without notice. By using this website
                you are agreeing to be bound by the then current version of these terms of service.</p>
            <h3>8. Governing Law</h3>
            <p>These terms and conditions are governed by and construed in accordance with the laws of Egypt and you irrevocably
                submit to the exclusive jurisdiction of the courts in that State or location.</p>
        </div>
    </div>
@endsection