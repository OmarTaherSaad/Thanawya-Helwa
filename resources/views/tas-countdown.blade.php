...
<div id="app">
    <div class="row justify-content-center">
        <div class="col-auto m-1" id="logoContainer">
            <a href="{{ Storage::url('assets/images/tas-logo.jpg') }}" class="progressive replace">
    ...
    <div class="row justify-content-center">
        <div class="col-12 text-center mb-1">
            <a type="button" class="btn btn-dark rounded" target="_blank" title="Facebook Event link" href="https://www.facebook.com/events/1099430050446914/">
                <h4>اضغط هنا للدخول على صفحة الايفينت على الفيسبوك</h4>
            </a>
        </div>
    </div>
    <div class="row justify-content-center">
