...
<!-- InstanceBegin template="/Templates/Main Template.dwt.php" codeOutsideHTMLIsLocked="true" -->
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
		...
		<a class="navbar-brand" href="index.php">
			<img src="{{ Storage::url('assets/blank.gif') }}" data-src="assets/images/logo.svg" onerror="this.src='../assets/images/logo.png'; this.onerror=null;" class="lazyload img-fluid" alt="فريق ثانوية حلوة">
		</a>
	...
	<script>
		...
		$('form').submit(function(event) {
			...
			grecaptcha.ready(function() {
				...
				grecaptcha.execute('6LdyhWEUAAAAABDOBrzpqRBksopIOuf_p2y3H991', {
					action: 'contact_form'
				}).then(function(token) {
					console.log(token);
					// add token to form
