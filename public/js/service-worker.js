...
workbox.routing.setDefaultHandler(new workbox.strategies.NetworkFirst()); //Fallback when offline to offline page

workbox.routing.setCatchHandler(function (_ref) {
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\TH-v2\resources\js\service-worker.js */"./resources/js/service-worker.js");
